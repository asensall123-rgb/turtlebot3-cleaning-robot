...
## mission.yaml Dosyası
- Görevler ve waypointler **config/mission.yaml** dosyasından alınır 
- QR kod içerikleri bu dosyada belirtilir 
- Kod üzerinde değişiklik yapmadan görevler düzenlenebilir 



## Hata Durumları
- QR kod okunamazsa:
  - 2 kez tekrar denenir, başarısızsa oda atlanır 
- move_base hedefe ulaşamazsa:
  - 1 kez tekrar denenir, başarısızsa oda **FAIL** olarak işaretlenir 
- Her hedef için timeout uygulanır 
